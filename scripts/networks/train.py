...
if __name__ == '__main__':
    ...
    da_model = tensor_utils.TensorDeformation(image_shape, parameter_dict['NONLINEAR'].lowres_size, device)
    ...
    log_keys = ['loss_' + lossname for lossname in loss_function_dict.keys()] + \
               ['w_loss_' + l for l in loss_function_dict.keys()] + ['loss', 'time_duration (s)']

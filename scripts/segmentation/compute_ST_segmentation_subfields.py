    ...
    def compute_p_label(self, timepoints, image_list, flow_dir, age_list, tp, subject, parameter_dict, regnet_model):
        ...
        for it_tp_flo, tp_flo in enumerate(timepoints):
            ...
            if tp_flo.id == tp.id:
                ...
                if not all([i == 'inf' for i in spatial_variance]):
                    ...
                    del im_resampled, im_flo_resampled
...
arg_parser.add_argument('--hemi', default=['rh', 'lh'], nargs='+', choices=['lh', 'rh'])
...
spatial_variance = [1, 4]#[3**2]#, 7**2] # in grayscale
